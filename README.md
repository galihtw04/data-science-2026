...
---
Repository ini dibuat sebagai portofolio pembelajaran mata kuliah Data Science. Tujuan dari repository ini adalah untuk mendokumentasikan proses belajar saya dalam memahami konsep dasar Data Science, mulai dari pengenalan Python, pengolahan data, eksplorasi data, visualisasi data, hingga penerapan machine learning sederhana.

Di dalam repository ini terdapat kumpulan notebook dari Pertemuan 1 sampai Pertemuan 7. Setiap notebook berisi latihan, kode program, hasil output, serta penerapan library Python yang umum digunakan dalam Data Science. Repository ini juga menjadi bukti perkembangan pemahaman saya dalam mengolah data, membersihkan data, melakukan analisis, membuat visualisasi, dan membangun model sederhana untuk membantu proses pengambilan keputusan berbasis data.
